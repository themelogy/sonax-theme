                        ...
                        @if($slider->video)
                            <!--BEGIN: SLIDE #3 -->
                                <li data-transition="fade" data-slotamount="1">
                                    ...
                                    <img alt=""
                                         src="{{ \Imagy::getImage($slider->files()->first()->filename, 'anasayfa_slider', ['width' => 1170, 'height' => 471, 'mode' => 'fit', 'quality' => 80]) }}"
                                    ...
                                    <div class="rs-background-video-layer"
                                         data-forcerewind="on"
                                         data-volume="50"
                                         data-ytid="{{ $slider->video }}"
                                         data-videoattributes="version=3&amp;enablejsapi=1&amp;html5=1&amp;hd=1&wmode=opaque&showinfo=0&ref=0;;origin={{ url('') }}"
                                         data-videorate="1"
                                         data-videowidth="100%"
                                         data-videoheight="100%"
                                         data-videocontrols="none"
                                         data-videostartat="00:00"
                                         data-videoendat="00:20"
                                         data-videoloop=""
                                         data-forceCover="1"
