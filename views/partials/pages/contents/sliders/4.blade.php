        ...
        <div class="tp-banner rev_slider" data-version="5.0">
            <ul>
                ...
                <li data-transition="fade" data-slotamount="1" data-masterspeed="1000">
                    <img alt="" src="{{ \Imagy::getImage($slider->files()->first()->filename, 'anasayfa_slider', ['width' => 1100, 'height' => 471, 'mode' => 'fit', 'quality' => 80]) }}" data-bgposition="center center"
...
<script>
    $(document).ready(function () {
        ...
        var height = (App.getViewPort().width > App.getBreakpoint('md') ? 450 : 300);
