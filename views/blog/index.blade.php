                        ...
                        <div class="c-content-blog-post-1-list">
                            ...
                            <div class="c-content-blog-post-1">
                                ...
                                <div class="c-desc"> {{ strip_tags($post->intro)  }}
                                    <a class="label label-danger c-font-slim" href="{{ $post->url }}">{{ trans('global.buttons.read more') }}</a>
                                </div>
                                <div class="c-panel">
                                    <div class="c-author">
                                        <a href="#">
                                    ...
                                    <ul class="c-tags c-theme-ul-bg">
                                        ...
                                        <li><a class="c-font-white" href="{{ route('blog.tag', [$tag->slug]) }}">{{ $tag->name }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
